...
@section('title', 'Admin | Update client package')
                        ...
                        <div class="col-lg-12 col-xl-12 order-lg-1 order-xl-1">
                            ...
                            <div class="kt-portlet w-100">
                                ...
                                <form class="kt-form kt-form--label-right" method="post"
                                    action="{{ route('client-packages.update', $clientPackage->id) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="m-3">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12">
                                                <input type="text" class="form-control" name="name"
                                                    value="{{ old('name', $clientPackage->name) }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-3 col-sm-12">Description *</label>
                                            <div class="col-lg-9 col-md-9 col-sm-12">
                                                <textarea class="form-control" name="description" placeholder="Enter a description" rows="8">{{ old('description', $clientPackage->description) }}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12">
                                                <input min="1" type="number" class="form-control" name="price"
                                                   value="{{ old('price', $clientPackage->price) }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12">
                                                <input min="1" type="number" class="form-control" name="package_expire_duration_in_days"
                                                     value="{{ old('package_expire_duration_in_days', $clientPackage->package_expire_duration_in_days) }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12">
                                                <input min="1" type="number" class="form-control" name="allowed_no_of_jobs_per_day"
                                                     value="{{ old('allowed_no_of_jobs_per_day', $clientPackage->allowed_no_of_jobs_per_day) }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12">
                                                <input min="1" type="number" class="form-control" name="job_expire_duration_in_days"
                                                     value="{{ old('job_expire_duration_in_days', $clientPackage->job_expire_duration_in_days) }}">
                                            </div>
                                        </div>
                                    </div>
