...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object#">
	...
	<link href="https://staticsn.com/_styles/registration.css?v=MatN8_q9UZGAQdY0ReFJVKPPYsk0PZDIYMBe0Z1rQkw1" rel="stylesheet"/>



	<title>Choose your membership type - StarNow</title>
	...
	<meta name="apple-mobile-web-app-capable" content="yes">
		...
		<link rel="canonical" href="https://www.starnow.com/register/member/" />

		<link rel="alternate" href="https://www.starnow.co.uk/register/member/" hreflang="en-GB" />
		<link rel="alternate" href="https://www.starnow.com.au/register/member/" hreflang="en-AU" />
		<link rel="alternate" href="https://www.starnow.com/register/member/" hreflang="en" />
		<link rel="alternate" href="https://www.starnow.com/register/member/" hreflang="x-default" />
		<link rel="alternate" href="https://www.starnow.co.nz/register/member/" hreflang="en-NZ" />
		<link rel="alternate" href="https://www.starnow.ie/register/member/" hreflang="en-IE" />
		<link rel="alternate" href="https://www.starnow.ca/register/member/" hreflang="en-CA" />

		
	<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@StarNow" />
<meta name="twitter:title" content="Choose your membership type" />
...
<meta property="og:title" content="Choose your membership type" />
...
<meta property="og:url" content="https://www.starnow.com/register/member/" />
...
<script nonce="BJNmLWoka6stxe3QSiyGRu+tnWhf7kJr">
	(function(w,d,u){w.readyQ=[];w.bindReadyQ=[];function p(x,y){if(x=="ready"){w.bindReadyQ.push(y);}else{w.readyQ.push(x);}};var a={ready:p,bind:p};w.$=w.jQuery=function(f){if(f===d||f===u){return a;}else{p(f);}};})(window,document);

	window.starnow = {page:{},environment:"www",release:"1.0.0.0",memberId:0,hasSignedInBefore:false,staticUrl:"https://staticsn.com",starNowApiUrl:"https://api.starnow.com",feedUrl:"https://feed.starnow.com",baseUrl:"https://www.starnow.com",currentURL:"/register/member",sessionCookie:"C539A5D1-BE9C-4128-8089-2FC2E87CC68A",user:{memberLevel:{id:0,label:"Trial",canAddFeaturedImages:false},id:0,anonymous:true,name:"Anonymous",firstName:"",memberType:"",stamp:0,isPaidMember:false,isInTalentDirectory:false,applicationCount:0,headshotUrl:"https://staticsn.com/images/register/no-headshot-25.png",profileUrl:"/0/",isPublic:false,isMinor:false,isEmailConfirmed:true}};
...
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-1051265680" nonce="BJNmLWoka6stxe3QSiyGRu+tnWhf7kJr"></script>
<script nonce="BJNmLWoka6stxe3QSiyGRu+tnWhf7kJr">
...
<script nonce="BJNmLWoka6stxe3QSiyGRu+tnWhf7kJr">
	...
	(function (snfb) {
		var snfbInit = {"auto":[],"fbid":null,"scope":"public_profile,email,user_birthday,user_gender","isRegistrationPage":true,"appId":192931954085724,"channelUrl":"https%3a%2f%2fwww.starnow.com%2ffbchannel.ashx","version":"v4.0","returnURL":"/register/member"};
...
<div class="reg-picker">
	<a href="{{route('home')}}" class="reg-picker__logo__wrapper nounder" tabindex="1" rel="home" title="Home">
		<img src="/images/logo.png" class="reg-picker__logo" alt="StarNow" width="152">
	</a>
	<div class="reg-picker__content">
		<div class="reg-picker__title">Sign up to...</div>
		<div>
			<a id="find-work-button" href="{{route('findwork')}}" class="reg-picker__option">
				Find<br />
				<span class="bold">work</span>
			</a>
			<a id="find-talent-button" href="{{route('findtalent')}}" class="reg-picker__option">
				Find<br />
				<span class="bold">talent</span>
			</a>
		</div>
	</div>
	<div class="reg-picker__footer">
		<a id="sign-in-link" class="reg-picker__footer__link nounder" href="/signin/?return_url=%2f">Member? Sign in here</a>
	</div>
</div>
...
<script nonce=BJNmLWoka6stxe3QSiyGRu+tnWhf7kJr>(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','//www.google-analytics.com/analytics.js','ga');
