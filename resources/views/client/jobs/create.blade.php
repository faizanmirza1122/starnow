                                ...
                                <form class="kt-form kt-form--label-right" method="post"
                                    ...
                                    <div class="kt-portlet__body">
                                        ...
                                        {{-- <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12">
                                                <input type="date" class="form-control" name="expire_in" value="{{ old('expire_in') }}">
                                            </div>
                                        </div> --}}
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12 form-group-sub">
                                                <select class="form-control" name="job_category_id" data-live-search="true">
                                                    ...
                                                    @foreach ($jobCategories as $jobCategory)
                                                        <option {{ old('job_category_id')==$jobCategory->id ? 'selected' : '' }} value="{{ $jobCategory->id }}">{{ $jobCategory->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12 form-group-sub">
                                                <select class="form-control" name="salary_range_id" data-live-search="true">
                                                    ...
                                                    @foreach ($salaryRanges as $salaryRange)
                                                        <option {{ old('salary_range_id')==$salaryRange->id ? 'selected' : '' }} value="{{ $salaryRange->id }}">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12 form-group-sub">
                                                <select class="form-control" name="experience_duration_id" data-live-search="true">
                                                    ...
                                                    @foreach ($expreienceDurations as $expreienceDuration)
                                                        <option {{ old('experience_duration_id')==$expreienceDuration->id ? 'selected' : '' }} value="{{ $expreienceDuration->id }}">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12 form-group-sub">
                                                <select class="form-control" name="experience_level_id">
                                                    ...
                                                    @foreach ($expreienceLevels as $expreienceLevel)
                                                        <option {{ old('experience_level_id')==$expreienceLevel->id ? 'selected' : '' }} value="{{ $expreienceLevel->id }}">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12 form-group-sub">
                                                <select class="form-control" name="country_id" data-live-search="true">
                                                    ...
                                                    @foreach ($countries as $country)
                                                        <option  {{ old('country_id')==$country->id ? 'selected' : '' }} value="{{ $country->id }}">{{ $country->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                <span class="form-text text-muted">Please select an option.</span>
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12 form-group-sub">
                                                <select class="form-control selectpicker" name="worker_roles[]" multiple data-live-search="true">
                                                    ...
                                                    @foreach ($workerRoles as $workerRole)
                                                        <option {{ old('worker_roles[]')==$workerRole->id ? 'selected' : '' }} value="{{ $workerRole->id }}">{{ $workerRole->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                <span class="form-text text-muted">Please select an option.</span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12 form-group-sub">
                                                <select class="form-control selectpicker" name="tags[]" multiple data-live-search="true">
                                                    ...
                                                    @foreach ($tags as $tag)
                                                        <option {{ old('tags[]')==$tag->id ? 'selected' : '' }} value="{{ $tag->id }}">{{ $tag->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                <span class="form-text text-muted">Please select an option.</span>
