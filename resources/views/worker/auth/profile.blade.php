...
<body id="ctl00_mainBody"
    ...
    <div class="row page-spacer">
        <div class="small-12 columns">
            ...
            <div class="section">
                <form method="post" action="{{ route('worker.update.profile') }}">
                    @csrf
                    @method('PUT')
                    ...
                    <fieldset class="fieldset-old">
                        <label>Email Address <span class="req">*</span> </label><input class="input-half"
                            id="email" maxlength="50" name="email" type="text" value="{{ old('email',$user->email) }}" disabled />
                    </fieldset>
                    <fieldset class="fieldset-old">
                        <label>First nme <span class="req">*</span> </label><input class="input-half"
                            id="first_name" maxlength="50" name="first_name" type="text" value="{{ old('first_name',$user->first_name) }}"
                             />
                        <label>Last name <span class="req">*</span> </label><input class="input-half"
                            id="last_name" maxlength="50" name="last_name" type="text" value="{{ old('last_name',$user->last_name) }}" />
                    </fieldset>
                    <fieldset class="fieldset-old">
                        <label>Username <span class="req">*</span> </label><input class="input-half"
                            id="username" maxlength="50" name="username" type="text" value="{{ old('username',$user->username) }}" />
                        <label>Phone # <span class="req">*</span> </label><input class="input-half"
                            id="phone" maxlength="50" name="phone" type="text" value="{{ old('phone',$user->phone)}}" />
                    </fieldset>
                    ...
                    <fieldset class="fieldset-old ">
                        <label>Country <span class="req">*</span>
                            ...
                            @foreach ($countries as $country)
                                <option value="{{ old('country', $country->id) }}" @if ($country->id == $user->country) selected @endif>
                                    {{ $country->name }}</option>
                            @endforeach
                        </select>
                    </fieldset>
                ...
                <form method="post" action="{{ route('worker.change.password') }}">
                    ...
                    <fieldset class="fieldset-old ">
                        <label>Old password <span class="req">*</span></label><input class="input-half"
                            id="old_password" maxlength="50" name="old_password" type="password" value="{{ old('old_password') }}" required />
                    </fieldset>
                    <fieldset class="fieldset-old ">
                        <label>New Password <span class="req">*</span></label><input class="input-half"
                            id="new_password" maxlength="50" name="new_password" type="password" value="{{ old('new_password') }}" required />
